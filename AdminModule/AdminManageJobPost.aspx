<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="AdminManageJobPost.aspx.cs" Inherits="JobPortalApplication.AdminModule.AdminManageJobPost" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table>
     ...
     <asp:TemplateField >
    <ItemTemplate>
       <asp:Button ID="btnblock" runat="server" Text=' <%#Eval("JobPostStatus").ToString()=="0" ? "Block" :"Blocked"%>' CommandName="A" CommandArgument=' <%#Eval("JobPostId") %>' />
    </ItemTemplate>
</asp:TemplateField>
